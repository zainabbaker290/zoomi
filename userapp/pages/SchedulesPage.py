                    ...
                    scheduleCard = Row(controls=[
                        Container(content=(Card(content=Column(controls=[
                            Container(content=Row(controls=[
                                Text(
                                    value=scheduleDict[object]["Name"], style="titleMedium", color=onT)
                            ],
                                alignment="center"), bgcolor=t, padding=5, border_radius=border_radius.only(topLeft=10, topRight=10)),
                            Container(content=Row(controls=[
                                Text(
                                    value=scheduleDict[object]["Day"], style="titleSmall"),
                                Text(
                                    value=scheduleDict[object]["Time"], style="titleSmall"),
                                Text(
                                    value=scheduleDict[object]["Repetition"], style="titleSmall"),
                            ...
                            Container(content=Column(controls=[
                                ...
                                Container(content=Row(controls=[
                                    Text(
                                        value=scheduleDict[object]["Mode"], style="labelMedium"),
                                    Text(
                                        value=scheduleDict[object]["Speed"], style="labelMedium"),
                                    Text(
                                        value=scheduleDict[object]["Laps"], style="labelMedium")
                                ], alignment="spaceEvenly"
                                )
                                )
                            ]
                        ...
                        Card(content=Container(content=Column(controls=[
                            IconButton(icon=icons.EDIT_OUTLINED, icon_color=onTC, icon_size=20, height=40,
                                       width=40, data=scheduleIndex, on_click=self.open_schedule_editor),
                        ...
                        Container(content=Card(content=Column(controls=[
                            ...
                            Container(content=Row(controls=[
                                ...
                                Text(
                                    value=scheduleDict[object]["Repetition"], style="titleSmall"),
                                Text(
                                    value=scheduleDict[object]["Profile"], style="titleSmall"),
                            ], alignment="spaceEvenly"
